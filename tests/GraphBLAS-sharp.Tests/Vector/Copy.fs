...
let testFixtures (case: OperationCase<VectorFormat>) =
    ...
    [ let intCopy = Vector.copy context wgSize CPUInterop
      ...
      let floatCopy = Vector.copy context wgSize CPUInterop
      ...
      let boolCopy = Vector.copy context wgSize CPUInterop
