module GraphBLAS.FSharp.Tests.Backend.Vector.AssignWithValue
...
let checkResult isZero isComplemented (actual: Vector<'a>) (vector: 'a []) (mask: 'a []) (value: 'a option) =
...
let testFixtures case =
    ...
    [ let intFill =
          Vector.assignByMaskWithOptionValue context Mask.assign wgSize
...
let testFixturesComplemented case =
    ...
    [ let intFill =
          Vector.assignByMaskComplementedWithOptionValue context Mask.assign wgSize
