...
let correctnessGenericTest
    ...
    resultZero
    op
    (addFun: MailboxProcessor<_> -> AllocationFlag -> ClVector.Sparse<'a> -> ClVector.Sparse<'b> -> ClVector.Sparse<'c>)
    (toDense: MailboxProcessor<_> -> AllocationFlag -> ClVector.Sparse<'c> -> ClArray<'c option>)
