                ...
                for offset in 0 .. (NNZInRow - 1) do
                    ...
                    if currentColumn <> 0 && numberOfZeroElements >= 0 then
                        for i in (currentColumn - numberOfZeroElements) .. currentColumn - 1 do
                            ...
                            let newMatrix = insert queue allocationMode rowOffset columnOffset mapWithZero resultMatrix
                            resultMatrix <- match resultMatrix.Matrix, mapWithZero.Matrix with
                    ...
                    let newMatrix = insert queue allocationMode rowOffset columnOffset mappedMatrix resultMatrix
                    resultMatrix <- match resultMatrix.Matrix, mappedMatrix.Matrix with
